Shader "Custom/Rainbow" {
	Properties {
		...
		//Textures
		[HideInInspector] _Splat3("Layer3 (A)", 2D) = "white" {}
		[HideInInspector] _Splat2("Layer2 (B)", 2D) = "white" {}
		[HideInInspector] _Splat1("Layer1 (G)", 2D) = "white" {}
		[HideInInspector] _Splat0("Layer0 (R)", 2D) = "white" {}
	...
	SubShader {
		...
		void surf (Input IN, inout SurfaceOutputStandard o) {
			...
			fixed4 splat0 = tex2D(_Splat0, IN.uv_Control) * _Color;
